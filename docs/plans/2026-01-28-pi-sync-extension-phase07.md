...
## Overview
Add README documentation and final polish.
...
1. Clone or copy this extension to your pi extensions directory:
   ```bash
   git clone https://github.com/yourusername/pi-opensync-plugin ~/.pi/agent/extensions/pi-opensync-plugin
...
The project includes `.pi/settings.json` which configures pi to load the extension from `./src`. This enables hot-reloading during development:
